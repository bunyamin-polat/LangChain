...
def main():
    ...
    result = agent.invoke({"messages": [HumanMessage(content="Search for 2 job postings for an AI Engineer using langchain in the by area on LinkedIn and list their details")]})
    print(result)
